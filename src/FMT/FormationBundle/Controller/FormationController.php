...
use FMT\FormationBundle\Entity\Formation;
...
class FormationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FMT\FormationBundle\Form\FormationType', $formation);
    ...
    {
        $deleteForm = $this->createDeleteForm($formation);
        $editForm = $this->createForm('FMT\FormationBundle\Form\FormationType', $formation);
