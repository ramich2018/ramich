...
use FMT\FormationBundle\Entity\Formateur;
...
class FormateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $formateurs = $em->getRepository('FormationBundle:Formateur')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FMT\FormationBundle\Form\FormateurType', $formateur);
    ...
    {
        $deleteForm = $this->createDeleteForm($formateur);
        $editForm = $this->createForm('FMT\FormationBundle\Form\FormateurType', $formateur);
