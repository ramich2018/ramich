...
use FMT\FormationBundle\Entity\Specialite;
...
class SpecialiteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $specialites = $em->getRepository('FormationBundle:Specialite')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('FMT\FormationBundle\Form\SpecialiteType', $specialite);
    ...
    {
        $deleteForm = $this->createDeleteForm($specialite);
        $editForm = $this->createForm('FMT\FormationBundle\Form\SpecialiteType', $specialite);
